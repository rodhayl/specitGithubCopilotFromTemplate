import { ConversationSessionRouter, ConversationRoutingResult } from '../../conversation/ConversationSessionRouter';
...
describe('ConversationSessionRouter', () => {
    ...
    describe('session state', () => {
        it('should return current session state', () => {
            ...
            expect(state.sessionMetadata.get(sessionId)).toEqual(metadata);
        });
