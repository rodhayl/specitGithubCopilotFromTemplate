import { AutoChatStateManager } from '../../src/conversation/AutoChatStateManager';
import { DocumentUpdateEngine } from '../../src/conversation/DocumentUpdateEngine';
import { ConversationSessionRouter } from '../../src/conversation/ConversationSessionRouter';
import { NewCommandHandler } from '../../src/commands/NewCommandHandler';
import { ParsedCommand, CommandContext } from '../../src/commands/types';
...
describe('Auto-Chat Workflow Integration', () => {
    ...
    describe('Error Handling and Recovery', () => {
        ...
        it('should handle document update failures', async () => {
            ...
            const FileUtils = require('../../src/utils/FileUtils').FileUtils;
